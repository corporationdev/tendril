...
function AgentRoute() {
  ...
  return (
    <main className="flex h-full min-h-[calc(100vh-3rem)] flex-col bg-background">
      <div className="border-b px-6 py-4">
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-semibold text-lg">Think Agent</h1>
          ...
          {messages.length === 0 ? (
            <Card>
              ...
              <CardContent className="text-muted-foreground text-sm">
                Ask the Think agent anything. Its chat history persists in the
