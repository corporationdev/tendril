...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@tendril/ui/components/sheet";
import { Skeleton } from "@tendril/ui/components/skeleton";
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
} from "@tendril/ui/components/tooltip";
import { useIsMobile } from "@tendril/ui/hooks/use-mobile";
...
function SidebarProvider({
  ...
  const setOpen = useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: shadcn persists sidebar state for reloads with a small UI preference cookie.
